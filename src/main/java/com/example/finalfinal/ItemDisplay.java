...
public class ItemDisplay {
    ...
    private VBox toRightPanel;
    private Button[] compares;
...
//        root.add(item8.getRoot(), 3, 1);
        ...
        root.setHgap(20);
        root.setVgap(20);
        root.getChildren().addAll(item1.getRoot(), item2.getRoot(), item3.getRoot(), item4.getRoot(), item5.getRoot(), item6.getRoot(), item7.getRoot(), item8.getRoot());
